...
![alt text](C:\Users\anton\Downloads\project-documents-ia\iaDocuments‐ Feito com o Clipchamp.gif)
...
4. Create a [.env](http://_vscodecontentref_/2) file in the `back-end-doc-ia` directory and add your OpenAI API key:
    ```env
...
Create a `Dockerfile` in the `back-end-doc-ia` directory:
